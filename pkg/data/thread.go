...
// CreatedAtDate ...format the CreatedAt date to display nicely on the screen to thread.
func (thread *Thread) CreatedAtDate() string {
	return thread.CreatedAt.Format("Jan 2, 2006 at 3:04pm")
}

// CreatedAtDate ...format the CreatedAt date to display nicely on the screen to post.
